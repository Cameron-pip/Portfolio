...
public class HW3Test {
	...
	public void test05EqualsEmpty() {
		...
		ArrayIntSet s1 = new ArrayIntSet(5);
		ArrayIntSet s2 = new ArrayIntSet(5);
		ArrayIntSet s3 = new ArrayIntSet(10);
		s2.addElement(5);
		assertEquals(s1, s3);
	...
	public void test05EqualsSingleElement() {
		...
		// s3 = s4 = { 5, 6 };
		ArrayIntSet s1 = new ArrayIntSet(5);
		ArrayIntSet s2 = new ArrayIntSet(8);
		ArrayIntSet s3 = new ArrayIntSet(5);
		ArrayIntSet s4 = new ArrayIntSet(8);
		s1.addElement(5);
		s2.addElement(5);
		s3.addElement(5);
		s4.addElement(5);
	...
	public void test05EqualsAddingElements() {
		// s1 = s2 = {1, 3, 5};
		ArrayIntSet s1 = new ArrayIntSet(10);
		ArrayIntSet s2 = new ArrayIntSet(20);
		s1.addElement(1);
		s1.addElement(3);
		s1.addElement(5);
		s2.addElement(1);
	...
	@Test
	public void test05AddElementPastArraySize() {
		ArrayIntSet s = new ArrayIntSet(2);
		for(int i = 0; i < 50000; i++)
			assertTrue(s.addElement(i*2));
		
		assertEquals(50000, s.size());
